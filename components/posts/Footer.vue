<template>
  <div class="px-4 w-full">
    <div class="mt-2 w-full">
      <p class="md:text-sm text-xs text-gray-600 flex w-full">
        <span class="justify-start">Liked by dharmik and 180 others</span>
        <span class="ml-auto pr-4">100 comments</span>
