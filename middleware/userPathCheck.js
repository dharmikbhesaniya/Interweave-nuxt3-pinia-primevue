export default defineNuxtRouteMiddleware((to, from) => {
  ...
  if (isLoggedIn) {
    ...
    else if(to.path === '/user/register/otp' && from.path === '/user/register/details') return true;
    else if(to.path === '/user/register/details' && from.path === '/user/register/username') return true;
    else if(to.path === '/user/register/username' && from.path === '/user/register/bio') return true;
    else if(to.path === '/user/register' && from.path === '/user/register/otp') return true;
